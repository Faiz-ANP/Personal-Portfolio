  ...
  return (
    <div id="projects" className="p-main">
      ...
      >
        ...
        <div className="crtn1">
          {/* <img src={proj} /> */}
          <p>Welcome to my project showcase! Here, you'll find a collection of React-based applications that highlight my skills in frontend development, UI/UX design, and API integration. Each project is built with modern web technologies, demonstrating my ability to create responsive, interactive, and user-friendly experiences.
          Feel free to explore my work below!</p>
        </div>
      </motion.div>
      <div className="list">
